...
EXEC sys.sp_rename 'dbo.udttCatalogContentProperty', 'temp_udttCatalogContentProperty';
GO
...
FROM sys.dm_sql_referencing_entities('dbo.udttCatalogContentProperty', 'TYPE');
...
GO
DROP TYPE dbo.temp_udttCatalogContentProperty;
GO
